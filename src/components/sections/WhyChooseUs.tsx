...
export const WhyChooseUs = () => {
    return (
        <Section className="py-24 relative border-b-[4px] border-[#d4af37] bg-gradient-to-b from-[#fdfbf7] to-[#f4ecd8] overflow-hidden">
            ...
            <div className="text-center mb-16 space-y-4 relative z-10 px-4">
                ...
                <h2 className="text-[40px] md:text-[56px] font-black text-[#4a0404] font-heading leading-tight drop-shadow-sm">
